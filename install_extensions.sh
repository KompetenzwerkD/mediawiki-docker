...
wget https://extdist.wmflabs.org/dist/extensions/TitleIcon-REL1_38-7a50e07.tar.gz
tar -xzf TitleIcon-REL1_38-7a50e07.tar.gz -C .
rm  TitleIcon-REL1_38-7a50e07.tar.gz
cd ..